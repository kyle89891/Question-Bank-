This project is a Question Bank web application built using Django, HTML, CSS, and Bootstrap. It allows users to manage questions, take quizzes, and view their marks. 
